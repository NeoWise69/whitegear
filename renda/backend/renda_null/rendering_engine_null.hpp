...
namespace wg {
    ...
    public:
        inline explicit rendering_engine_null(const rendering_engine_create_info& info) {}
        inline ~rendering_engine_null() override = default;

        inline void draw_mesh(const mesh_render_data* p_data) override {}
        inline void load_mesh(const mesh_load_data* load_data) override {}
        inline void unload_mesh(entity_t entity_id) override {}
