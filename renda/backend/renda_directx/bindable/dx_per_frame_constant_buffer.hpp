...
#ifndef WHITEGEAR_DX_PER_FRAME_CONSTANT_BUFFER_HPP
#define WHITEGEAR_DX_PER_FRAME_CONSTANT_BUFFER_HPP
...
namespace wg {
    class dx_bindable_per_frame_constant_buffer : public dx_bindable_base {
    public:
...
#endif //WHITEGEAR_DX_PER_FRAME_CONSTANT_BUFFER_HPP
